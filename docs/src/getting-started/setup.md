...
> [!TIP]
> There are many, many ways to invoke commands like this. For example, you can select `Open File` from the `File` menu to open a file, or you could also click the `Open…` button and select `Open File` from the dropdown.
>
