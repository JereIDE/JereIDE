...
# Produces:
#   dist\jereide-${Version}-windows-x86_64\        (staging directory)
#   dist\jereide-${Version}-windows-x86_64.zip     (release archive)
...
$ArchiveBase = "jereide-$Version-windows-x86_64"
...
$Binary = Join-Path $RootDir 'target\release\jereide.exe'
