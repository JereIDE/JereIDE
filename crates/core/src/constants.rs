...
pub const EDITOR_INNER_MARGIN_TOP: i8 = 8;
pub const EDITOR_INNER_MARGIN_BOTTOM: i8 = 8;
...
pub const GUTTER_PADDING_LEFT: f32 = 12.0;
pub const GUTTER_PADDING_RIGHT: f32 = 6.0;
pub const GUTTER_LINE_NUMBER_RIGHT_OFFSET: f32 = 10.0;
...
pub const TAB_CLOSE_BTN_RADIUS: u8 = 4;
pub const TAB_CLOSE_BTN_SPACING: f32 = 8.0;
