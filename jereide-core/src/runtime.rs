...
fn find_data_dir(_exe_file: &Path, exe_dir: &Path) -> PathBuf {
    ...
    // macOS app bundle: exe is at .app/Contents/MacOS/jereide.
...
fn find_user_dir(_exe_file: &Path, exe_dir: &Path, _path_sep: char) -> PathBuf {
